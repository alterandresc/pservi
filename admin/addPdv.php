...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    <form action="savePdv.php" method="POST">

      <div class="row">
        <div class="col-md-6" > <label for="exampleInputEmail1"> IDENTIFICADOR </label> </div>
        <div class="col-md-7">
          <input type="text" name="c_costo_id" value=""  size="35">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <input type="text" name="c_costo_nombre" value=""  size="35">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <input type="text" name="pais" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <input type="text" name="ciudad" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
       <div class="col-md-6" > <label for="exampleInputEmail1"> REGIONAL </label></div>
        <div class="col-md-6">
          <input type="text" name="regional" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
       <div class="col-md-6" > <label for="exampleInputEmail1"> ZONA </label></div>
        <div class="col-md-6">
          <input type="text" name="zona" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <input type="text" name="direccion" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <input type="text" name="unidad_negocio" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
       <div class="col-md-6" > <label for="exampleInputEmail1"> LATITUD </label></div>
        <div class="col-md-6">
          <input type="text" name="latitud" size="35" value="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <input type="text" name="longitud" size="35" value="">
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
