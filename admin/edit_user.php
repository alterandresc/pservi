  ...
  <body>
    ...
    <form action="updateUser.php" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <input type="text" name="usuario_email" value="<?php echo $user['usuario_email']?>"  size="35">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <select id="nivel" class="form-control" name="nivel" value="<?php echo $user['nivel']?>" >
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <select id="estado" class="form-control" name="estado" value="<?php echo $user['estado']?>" >
    ...
    <script>
    $('#nivel').val("<?php echo $user['nivel']; ?>");
    $('#estado').val("<?php echo $user['estado']; ?>");
    </script>
  </body>
</html>
