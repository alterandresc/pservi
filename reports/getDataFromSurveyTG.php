...
//   FILE DOWNLOAD
  ...
  $new_filename = sprintf("files/new_eval_popsy_%s.csv",$date);
  $cmd_to_execute = sprintf("wget http://synapsis-rs.org/popsy/popsy.csv -O %s", $new_filename);
  exec($cmd_to_execute);
  $result = array();
