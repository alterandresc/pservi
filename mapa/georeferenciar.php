<?
//<td width="66"><input type="submit" name="Procesar" onclick = "this.form.action = 'mapas_marcador_procesa.php'" value="Procesar" />//	  
// ------------------------------------------------------------------------
...
$latitud= "4.598072987977448";
$longitud="-74.0760678930664";
$zoom= "12";
$tipo_mapa = "ROADMAP";
$direccion = "";
...
<div id="formulario">
  ...
  <form name="form_mapa" method="POST" enctype="multipart/form-data">
       <table width="1130" align="center">
        ...
        <td width="513"><p style="font-size: 10px;font-family: verdana;font-weight: bold;">
  	   Dir:&nbsp;<input type="text" name="direccion" id="direccion" value="<?echo $direccion;?>" style="width: 350px;font-size: 10px;font-family: verdana;font-weight: bold;" />
  	   &nbsp;
            <input type="button" value="Geo->Dir" onclick="codeAddress()">
          </p>
  	    </td>
	<td width="225"><p style="font-size: 10px;font-family: verdana;font-weight: bold;">&nbsp;Lat:&nbsp;
	    <input type="text" name="latitud" value="<?echo $latitud;?>" style="width: 150px;font-size: 10px;font-family: verdana;font-weight: bold;" />	    
	</p>
	</td>
	<td width="306"><p style="font-size: 10px;font-family: verdana;font-weight: bold;">Lon:&nbsp; <input type="text" name="longitud" value="<?echo $longitud;?>" style="width: 150px;font-size: 10px;font-family: verdana;font-weight: bold;" />	
	   &nbsp;&nbsp;<input type="button" value="Geo->LatLon" onclick="codeLatLon()">
	</p></td>
    <td width="66"><input type="submit" name="Procesar" value="Procesar" />	   
	</td>	
	</tr>
     </table> 
     </form>
